...
export function FocusMode ({ scope: scopeProp, repos, events, stats, mood, wardrobe, onClose }: {
  ...
  wardrobe: Wardrobe;        // v0.2.7.0 B.2: the same App-derived wardrobe
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-6">
        ...
        <div className="flex items-center justify-center gap-3">
          {/* v0.1.13.0 D2 (B.2): Kat on the wall — element 8, beside the
              ...
              (v0.2.7.0 B.2: and the same earned wardrobe). */}
